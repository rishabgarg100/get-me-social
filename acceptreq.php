...
<div id="wrapper">
	...
	<div id="page">
		...
		<br />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<div style="position: absolute; width: 582px; height: 551px; z-index: 9; left: 457px; top: 339px" id="layer20" class="style8">
			...
			$fid = $_GET['id'];
			include("db.php");
			$qry = "update tbfriend set status = 1 where userid='$fid' and friendid='$ui' "; 
            ...
            $n = $row[0];
            $n++;
            $qry = "insert into tbfriend value ($n,'$ui','$fid',1) ";
			mysqli_query($con,$qry) or die(mysqli_error($con));

			?>
			<?php
			$qry = "select uname from tbuser where userid ='$fid'";
			$result = 	mysqli_query($con,$qry) or die(mysqli_error($con));
            $row = mysqli_fetch_row($result);

			?>
			FRIEND REQUEST ACCEPTED <br />
			<br />
			YOU ARE CONNECTED WITH&nbsp;&nbsp;&nbsp; <i><?php echo $row[0];  ?> </i></strong>
