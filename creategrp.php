...
function validate()
	{// alert("hi1"); alert("hi");
	var gn = document.myform.Text1.value;
	var desc = document.myform.TextArea1.value;
	var img = document.myform.File1.value;
		var flag = true;
	...
	document.getElementById('ul1').innerHTML="";
	   ...
	   {  // alert("hi1");
	      ...
	      document.getElementById('ul1').innerHTML="<li>GROUPNAME CANNOT BE EMPTY</li>";
	       flag = false;
	   }
	   if (desc == "")
	   {   // alert("hi2");
	        document.getElementById('td2').innerHTML="*";
	       document.getElementById('ul1').innerHTML+="<li>DESCRIPTION CANNOT BE EMPTY</li>";
	        flag = false;
	   }  
	      if (img == "")
	   {   // alert("hi2");
	        document.getElementById('td3').innerHTML="*";
	       document.getElementById('ul1').innerHTML+="<li>IMAGE CANNOT BE EMPTY</li>";
	        flag = false;
	   }   
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div class="style6"  style="position: absolute; width: 252px; height: 70px; z-index: 8; left: 257px; top: 14px;" id="layer21">
		<br />
		<span class="style7">CREATE&nbsp; GROUP</span></div>
			<br />
			<br />
			<br />
			<br />
			...
			<br />
			<br />
			<div style="position: absolute; width: 407px; height: 424px; z-index: 9; left: 169px; top: 115px" id="layer22">
				<form method="post" name="myform" action="creategrp2.php" onsubmit="return validate()" enctype="multipart/form-data">
					<table style="width: 100%; height: 181px">
						<tr>
							<td style="width: 114px; height: 50px;">GROUP NAME</td>
							<td style="height: 50px; width: 266px;">
							<input name="Text1" type="text" style="width: 250px; height: 27px" />&nbsp;</td>
							<td id="td1" style="height: 50px">
							&nbsp;</td>
						</tr>
						<tr>
							<td style="width: 114px; height: 132px;">DESCRIPTION</td>
							<td style="height: 132px; width: 266px;">
							<textarea name="TextArea1" style="width: 250px; height: 89px"></textarea>&nbsp;</td>
							<td id="td2" style="height: 132px">
							&nbsp;</td>
						</tr>
						<tr>
							<td style="width: 114px; height: 55px;">IMAGE</td>
							<td style="height: 55px; width: 266px;">
							<input name="File1" type="file" style="height: 36px; width: 219px" />&nbsp;</td>
							<td id="td3" style="height: 55px">
							&nbsp;</td>
						</tr>
						<tr>
							<td style="width: 114px; height: 57px"></td>
							<td style="height: 57px; width: 266px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="Submit1" type="submit" value="CREATE" style="width: 101px; height: 32px" /></td>
