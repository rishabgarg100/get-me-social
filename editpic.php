...
<div id="wrapper">
	...
	<div id="page">
		...
		<div style="position: absolute; width: 582px; height: 551px; z-index: 9; left: 457px; top: 339px" id="layer20">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<div class="style6"  style="position: absolute; width: 201px; height: 62px; z-index: 8; left: 259px; top: 20px;" id="layer21">
		<br />
		<a id="a3" href="editpic.php"><span class="style7">EDIT PICTURE</span></a></div>
			<div style="position: absolute; width: 391px; height: 100px; z-index: 9; left: 176px; top: 161px" id="layer22">
				<form method="post" action="editpic2.php" enctype="multipart/form-data">
					<table style="width: 100%; height: 103px">
						<tr>
							<td style="width: 114px; height: 48px" class="style9">
							IMAGE</td>
							<td class="style8" style="height: 48px">
							<input name="File1" type="file" style="width: 220px; height: 24px" />&nbsp;</td>
						</tr>
						<tr>
							<td style="width: 114px">&nbsp;</td>
							<td>
							<input name="Submit1" type="submit" value="UPLOAD" style="width: 111px; height: 34px" />&nbsp;</td>
						</tr>
					</table>
					<br />
				</form>
