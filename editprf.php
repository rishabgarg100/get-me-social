...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<?php
	    ...
	    ifnull(qualification,''), ifnull(sports,'') from tbuser where userid = '$ui' ";    
	    $result = mysqli_query($con,$qry) or die(mysqli_error($con));
	    $row = mysqli_fetch_row($result);
?>

			<form method="post" action="editprf2.php" style="width: 420px; height: 295px">
				<table style="width: 106%; height: 313px">
					...
					<tr>
						...
						<td>
						<input name="Text2" type="text" value="<?php echo $row[1] ?>" style="width: 240px; height: 25px;" />&nbsp;</td>
					</tr>
					<tr>
						<td style="width: 169px" class="style8">HOBBIES</td>
						<td>
						<input name="Text3" type="text" value="<?php echo $row[2] ?>" style="width: 240px; height: 25px;" />&nbsp;</td>
					</tr>
					<tr>
						<td style="width: 169px" class="style8">INTERESTS</td>
						<td class="style8">
						<input name="Text4" type="text" value="<?php echo $row[3] ?>" style="width: 240px; height: 25px;" />&nbsp;</td>
					</tr>
					<tr>
						<td style="width: 169px" class="style8">QUALIFICATIONS</td>
						<td>
						<input name="Text5" type="text" value="<?php echo $row[4] ?>" style="width: 240px; height: 25px;" />&nbsp;</td>
					</tr>
					<tr>
						<td style="width: 169px" class="style8">SPORTS</td>
						<td>
						<input name="Text6" type="text" value="<?php echo $row[5] ?>" style="width: 240px; height: 25px;" />&nbsp;</td>
					</tr>
					<tr>
						<td style="width: 169px">&nbsp;</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
						<input name="Submit1" type="submit" value="UPDATE" style="width: 114px; height: 31px" />&nbsp;</td>
					</tr>
				</table>
				<br />
			</form>
