...
<div id="wrapper">
	...
	<div id="page">
	  ...
	  $qry = "update tbuser set uname='$un',about='$uab',hobbies='$uho',interests='$uin',
	  qualification='$uqua',sports='$uspo' where userid='$ui' ";
	  mysqli_query($con,$qry) or die(mysqli_error($con));
	?></b>	
	<b><br />
		<br />
		<br />
		YOUR PROFILE HAS BEED UPDATED SUCCESFULLY<br><br>
		</b>
	</div>
		<br />
		&nbsp;&nbsp;<br />
