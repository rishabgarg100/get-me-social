...
<div id="wrapper">
	...
	<div id="page">
		...
		<div class="style6"  style="position: absolute; width: 220px; height: 65px; z-index: 8; left: 256px; top: 19px;" id="layer21">
		<br />
		<a id="a3" href="editpic.php"><span class="style9">S</span></a><a href="editpic.php" class="style7"><span class="style8"><span class="style9">ECURITY 
		SETTING</span></span></a></div>
			<br />
			<br />
			<div style="position: absolute; width: 423px; height: 192px; z-index: 9; left: 161px; top: 149px" id="layer22">
				
				<?php
		include("db.php");
	    $qry = " select sques,sans from tbuser where userid = '$ui' ";    
	    $result = mysqli_query($con,$qry) or die(mysqli_error($con));
	    $row = mysqli_fetch_row($result);
?>

				
				<form method="post" action="editsec2.php" style="width: 357px">
					<table style="width: 115%; height: 145px">
						<tr>
							<td style="width: 157px">SECURITY&nbsp; QUESTION</td>
							<td>
							<input name="Text1" type="text" value="<?php echo $row[0] ?>" style="width: 234px; height: 27px" />&nbsp;</td>
						</tr>
						<tr>
							<td style="width: 157px">ANSWER</td>
							<td>
							<input name="Text2" type="text" value="<?php echo $row[1] ?>" style="width: 234px; height: 27px;" />&nbsp;</td>
						</tr>
						<tr>
							<td style="width: 157px">&nbsp;</td>
							<td>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="Submit1" type="submit" value="UPDATE" style="width: 116px; height: 29px" />&nbsp;</td>
						</tr>
					</table>
					<br />
					<br />
