...
<div id="wrapper">
	...
	<div id="page">
		...
		<div class="style10"  style="position: absolute; width: 271px; height: 77px; z-index: 8; left: 221px; top: 303px;" id="layer21">
		<br />
		<a id="a5" href="viewfrdlist.php">VIEW FRIENDS LIST</a></div>
		<div class="style6"  style="position: absolute; width: 271px; height: 77px; z-index: 8; left: 221px; top: 186px;" id="layer22">
		<br />
		<span class="style9"><a id="a5" href="checkreq.php">CHECK REQUESTS</a></span></div>
		<div class="style6"  style="position: absolute; width: 271px; height: 77px; z-index: 8; left: 221px; top: 69px;" id="layer23">
		<br />
		<a id="a5" href="searchuser.php"><span class="style9">S</span></a><a href="searchuser.php" class="style7"><span class="style8"><span class="style9">EARCH 
		USERS</span></span></a></div>
			</div>
		<br />
		&nbsp;&nbsp;<br />
		<br />
