...
<div id="wrapper">
	...
	<div id="page">
		...
		<div class="style10"  style="position: absolute; width: 350px; height: 77px; z-index: 8; left: 210px; top: 303px;" id="layer21">
		<br />
		<a id="a5" href="viewjoingrp.php">VIEW JOINED GROUPS</a></div>
		<div class="style6"  style="position: absolute; width: 350px; height: 77px; z-index: 8; left: 210px; top: 186px;" id="layer22">
		<br />
		<span class="style9"><a id="a5" href="viewgrp.php">VIEW AVAILABLE GROUPS</a></span></div>
		<div class="style6"  style="position: absolute; width: 350px; height: 77px; z-index: 8; left: 210px; top: 69px;" id="layer23">
		<br />
		<span class="style9"><a id="a5" href="creategrp.php">CREATE NEW GROUP</a></span></div>
			</div>
		<br />
		&nbsp;&nbsp;<br />
		<br />
