...
<div id="wrapper">
	...
	include("db.php");
	$gid = $_GET["gid"];
	$qry = "select ifnull(max(sno),0) from tbgroupmember";
	$result = mysqli_query($con,$qry) or die(mysqli_error($con));
	$row = mysqli_fetch_row($result);
	$n = $row[0];
	$n++;
	$qry = "insert into tbgroupmember values($n,'$ui',$gid)";
    ...
    ?>	
			...
			<br />
			<br />
			<span class="style7">YOU HAVE SUCCESSFULLY JOINED THE GROUP</span></div>
		<br />
		&nbsp;&nbsp;<br />
		<br />
		<br />
