...
<div id="wrapper">
	...
	<div id="menu" class="style2" style="height: 64px">
		<ul>
			...
			<li class="current_page_item"><a id="a2" href="messages.php">Messages</a></li>
	...
	<div id="page">
		...
		<div style="position: absolute; width: 582px; height: 551px; z-index: 9; left: 457px; top: 339px ; overflow:scroll" id="layer20" >
			<?php
			 include("db.php");
			 $qry = "select a.msgdesc,a.frmusrid,b.imgname,a.date,a.time from tbmsg a, tbuser b where a.tousrid = '$ui' and 
			 a.frmusrid = b.userid ORDER BY msgid desc";
			 ...
			 <tr>
              <td><img src="<?php echo $row[2]; ?>" height=70 width=70 /><center><?php echo $row[1];?></center></td>
              <td>
              <big><b><?php echo $row[0]; ?></b></big>
              <br>
              <small><?php echo $row[3];?> &nbsp;&nbsp; <?php echo $row[4]; ?> </small>
              </td>		
              <td><a  href="reply.php?sid=<?php echo $row[1]; ?>"> reply</a> </td> 
			  </tr>
