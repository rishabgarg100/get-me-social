...
<div id="wrapper">
	...
	<div id="page">
		...
		<div style="position: absolute; width: 582px; height: 551px; z-index: 9; left: 457px; top: 339px;overflow:scroll" id="layer20">
			...
			include("db.php");
			$gid = $_GET["gid"];
			$qry = "select * from tbgrouptopic where groupid =$gid ORDER BY topicid desc ";
			...
			?>
				<tr style="height:120px; border-bottom:medium;border-bottom-color:maroon">
					<td style="height: 74px; width: 386px;">
					<b><big><big><big><big><a id="a4" href="viewcmt.php?tid=<?php echo $row[0]; ?>"><?php echo $row[2]; ?></a></big></big></big></big></b>
					<br/>
					<small><?php echo $row[4]; echo "  &nbsp &nbsp".$row[5]; ?></small>
					
					</td>
					<td style="height: 74px">
			POSTED BY 
		<span class="style7"><a id="a1" href="viewprf.php?id=<?php echo $row[3] ?>"><?php echo $row[3] ?></a></span> <br />
					</td>
				</tr>
				<?php } ?>
			</table>
