...
if(img=="")
{
document.getElementById('td1').innerHTML = "insert URL"
flag = false;
}
return flag;
}
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div class="style6"  style="position: absolute; width: 201px; height: 52px; z-index: 8; left: 237px; top: 9px;" id="layer21">
		<br />
		<a id="a3" href="editprf.php"> </a>
		<span class="style8">ADD PICTURES</span></div>
			<div style="position: absolute; width: 478px; height: 100px; z-index: 9; left: 93px; top: 71px" id="layer22">
				<form method="post" action="addimg.php" enctype="multipart/form-data" name="myform" onsubmit="return validate()">
					<table style="width: 100%; height: 117px">
						<tr>
							<td class="style9" style="width: 120px">ADD IMAGE</td>
						<td style="width: 232px">
						<input name="File1" type="file" style="width: 224px; height: 24px" />&nbsp;</td>
						<td id="td1">&nbsp;</td>
						</tr>
						<tr>
							<td style="width: 120px">&nbsp;</td>
						<td style="width: 232px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input name="Submit1" type="submit" value="ADD" style="width: 108px; height: 32px" />&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
				</table>
			</form>
		</div>
				<div style="position: absolute; width: 480px; height: 309px; z-index: 10; left: 94px; top: 224px;overflow:scroll" id="layer23" class="style10">
				<?php 
				include("db.php");
				$qry = "select sno,uimg from tbimage where userid = '$ui'";
                ...
                while($row = mysqli_fetch_row($result))
                {
                  ...
                  echo "<td>";
                  ?>
                  <a href="viewimg.php?imid=<?php echo $row[0]; ?>" >
				<img src="<?php echo $row[1]; ?>" width="150" height="150" />
				</a>
				<?php
			 echo "</td>";
             if($counter>1)
