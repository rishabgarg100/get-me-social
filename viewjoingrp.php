...
<div id="wrapper">
	...
	<div id="page">
		...
		<br />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<div style="position: absolute; width: 582px; height: 551px; z-index: 9; left: 457px; top: 339px;overflow:scroll" id="layer20">
			<?php
			include("db.php");
			$qry = "select a.groupid,b.gname,b.gimg from tbgroup b, tbgroupmember a where a.groupid = b.groupid and a.userid = '$ui' ";
			...
			{
			?>
				<tr style="height:120px; border-bottom:medium;border-bottom-color:maroon">
					<td style="width: 110px; height: 74px">
					<img src="<?php echo $row[2]; ?>" width=100 height = 100 /></td>
					<td style="width: 316px; height: 74px"><b><big><big><big><big><big><big><?php echo $row[1]; ?></big></big></big></big></big></big></b></td>
					<td style="height: 74px">
			
		<a id="a5" class="style7" href="viewjoingrp2.php?gid=<?php echo $row[0]; ?>"><span class="style7">BLOG</span></a>
					</td>
				</tr>
				<?php } ?>
			</table>
