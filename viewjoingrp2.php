...
<div id="wrapper">
	...
	<div id="page">
		...
		<br />
		<span class="style9"><a id="a5" href="viewblog.php?gid=<?php echo $gid; ?>">VIEW AVAILABLE BLOGS </a>
		</span></div>
		<div class="style6"  style="position: absolute; width: 350px; height: 77px; z-index: 8; left: 210px; top: 69px;" id="layer23">
		<br />
		<span class="style9"><a id="a5" href="createblog.php?gid=<?php echo $gid; ?>">CREATE NEW BLOG</a>
		</span></div>
			</div>
		<br />
		&nbsp;&nbsp;<br />
...
<div id="footer-content">
	s<div class="column1">
		...
		<a href="http://www.facebook.com">www.getmesocial.com</a> is 
