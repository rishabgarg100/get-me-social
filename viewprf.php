...
?>
		...
		<div class="style6"  style="position: absolute; width: 201px; height: 52px; z-index: 8; left: 190px; top: 322px;" id="layer23">
		<br />
		<?php 
		if($n==0)
		{
		?>
		<a id="a3" href="sendreq.php?id=<?php echo $sid ?>" class="style9"><span class="style10">SEND 
		REQUEST</span></a></div>
						</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
