...
?>
		...
		<div class="style6"  style="position: absolute; width: 201px; height: 52px; z-index: 8; left: -22px; top: 314px;" id="layer23">
		<br />
		<a id="a3" href="acceptreq.php?id=<?php echo $sid ?>" class="style9"><span class="style10">ACCEPT 
		REQUEST</span></a></div>
						</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="style6"  style="position: absolute; width: 201px; height: 52px; z-index: 8; left: 268px; top: 312px;" id="layer24">
		<br />
		
		<a id="a4" href="rejectreq.php?id=<?php echo $sid ?>" class="style9">
		<span class="style10">&nbsp;REJECT REQUEST</span></a></div>
						<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
						&nbsp;</td>
					</tr>
